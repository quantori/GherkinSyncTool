...
namespace GherkinSyncTool.Synchronizers.AllureTestOps.Model
{
    ...
    {
        public CreateTestCaseRequest CreateTestCaseRequest { get; set; } = new CreateTestCaseRequest();
        
        /// <summary>
        /// Dictionary consists of step number and attachment.
        /// </summary>
        public Dictionary<int, ByteArrayPart> StepsAttachments { get; set; } = new Dictionary<int, ByteArrayPart>();
    }
}